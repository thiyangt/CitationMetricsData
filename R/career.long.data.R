#' career.long.data: contains Career-long data are updated to end-of-2023
#'
#'@description This dataset contains Table 1 (Table_1_Authors_career_2023_pubs_since_1788_wopp_extracted_202408.xlsx)of August 2024 data-update for "Updated science-wide author databases of standardized citation indicators"
...
#' \item{nc9623 (ns)}{total cites 1996-2023}
